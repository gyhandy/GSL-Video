...
from solver_supervised_face import Solver
...
if __name__ == "__main__":
    ...
    # model params
    parser.add_argument('--crop_size', type=int, default=128, help='crop size for the ilab dataset')
    ...
    parser.add_argument('--lambda_unsup', default=0.2, type=float, help='lambda_recon')
    parser.add_argument('--lambda_cycle', default=1, type=float, help='lambda_cycle')
    ...
    parser.add_argument('--z_unknow_dim', default=40, type=int, help='dimension of the pose/background in z')
    ...
    parser.add_argument('--viz_name', default='ilab_face_unsup', type=str, help='visdom env name')
