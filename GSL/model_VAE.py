...
class AE_H(nn.Module):
    ...
    def _decode(self, z):
        return self.decoder(z)
class BetaVAE_D_pose(nn.Module):
    """Model proposed in original beta-VAE paper(Higgins et al, ICLR, 2017)."""

    def __init__(self, input_dim, num_pose=6):
        super(BetaVAE_D_pose, self).__init__()
