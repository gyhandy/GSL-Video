...
from model_VAE import BetaVAE_H, BetaVAE_B, BetaVAE_D_pose
from model_sup_Zdim10_dsprites import Generator_fc
...
class Solver(object):
    def __init__(self, args):
        ...
        if args.dataset.lower() == 'dsprites':
            ...
            self.nc = 3
            self.decoder_dist = 'gaussian'
        elif args.dataset.lower() == 'dsprites_unsup_nswap':
            self.nc = 1
            self.decoder_dist = 'bernoulli'
        else:
