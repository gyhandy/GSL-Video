...
# Raw_Data_root = '/home2/ilab2M_pose/test_img_c00_10class_base/'
# Raw_Data_root = '/home2/ilab2M_pose/test_img_c00_10class_base_single/'

# Raw_Data_root = '/home2/ilab2M_pose/vae_unsup_tri/'
Raw_Data_root = '/home2/ilab2M_pose/vae_synthesized/synthesize/sample_img'
Target_root ='/home2/ilab2M_pose/vae_synthesized/category/'
# Raw_Data_root = '/home2/ilab2M_pose/story/story_train_synthesized_single'
# Target_root ='/home2/ilab2M_pose/story/'
task = 'normal' # 'synthesized', 'normal'
DATA_NAME = 'train_img' # train_img, test_img, val_img
IMAGE_TYPE = '.jpg'
# all_class_dict = ['boat', 'bus', 'car', 'equipment', 'f1car', 'helicopter', 'military', 'monster truck', 'pickup truck', 'plane', 'semi truck', 'tank', 'train', 'UFO', 'van']
all_class_dict = {'boat': '0', 'bus': '1', 'car': '2', 'mil': '3', 'monster': '4', 'pickup': '5', 'semi': '6', 'tank': '7', 'train': '8', 'van': '9'}

excluded_class = ['equip', 'f1car', 'heli', 'plane', 'ufo']
if not os.path.exists(Target_root):
    os.makedirs(Target_root)
for key in all_class_dict.keys():
    if not os.path.exists(os.path.join(Target_root, key)):
        os.makedirs(os.path.join(Target_root, key))
inverse_dict = {value: key for key, value in all_class_dict.items()}
train_ratio = 1
for roots, dirs, files in os.walk(Raw_Data_root):
    for i, file in enumerate(files):
        # print(file)
        label = file.split('[')[1].split(']')[0]
        category = inverse_dict[label]
        shutil.copy(os.path.join(roots, file), os.path.join(Target_root, category, file))
